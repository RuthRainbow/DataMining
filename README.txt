...
- scilearn.py: performs 10-fold cross validation on 10 different classifiers from the sklearn module. Also performs 4 different clustering algorithms. Three feature selection methods are available, and may be selected using flags at the top of the file.
