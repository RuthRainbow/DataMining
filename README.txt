...
- scilearn.py: performs 10-fold cross validation on 10 different classifiers from the sklearn module. Also performs four different clustering algorithms. Three feature selection methods are available, and may be selected using flags at the top of the file.
...
Raw results produced by a variety of different feature selection methods can be found in results/. A report describing the assignment and evaluating the results can be found in report/.
