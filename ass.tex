...
The Na{\"i}ve Bayes classifier obtained an accuracy over the test set of 72.8\%. Below are the most informative features the classifier found when comparing classes:
...
\clearpage
\section{Binary Vectorisation Results}
...
\clearpage
\section{TFIDF Vectorisation Results}
